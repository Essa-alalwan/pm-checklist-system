...
// One fillable measurement cell on a custom checklist type. Fields sharing a
// groupLabel render together; more than one distinct rowLabel in a group
// makes it a real row x column table, otherwise it's a flat labeled-field list.
