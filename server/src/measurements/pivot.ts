...
// Turns a template's flat list of measurement field definitions into
// renderable groups. Shared by the PDF generator and (mirrored on the
// frontend) the wizard step / read-only view, so all three render the exact
